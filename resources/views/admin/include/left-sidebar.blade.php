    ...
    <div class="iconmenu">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Application">
                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#setting" type="button"><i class="bi bi-grid-fill"></i></button>
            </li>
        ...
        <div class="tab-content">
            <div class="tab-pane fade" id="dashboard">
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{route('home')}}" class="list-group-item"><i class="bi bi-cart-plus"></i>Dashboards</a>
            ...
            <div class="tab-pane fade" id="setting">
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{route('add-product')}}" class="list-group-item"><i class="bi bi-envelope"></i>Add Product</a>
                </div>
            </div>
...
{{--                    <a href="ecommerce-transactions.html" class="list-group-item"><i class="bi bi-handbag"></i>Transactions</a>--}}
                    <a href="{{route('slider')}}" class="list-group-item"><i class="bi bi-envelope"></i>Add Slider</a>
                </div>
            </div>
