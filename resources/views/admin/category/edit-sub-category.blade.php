...
@section('content')
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleDarkModal">Update Sub Category</button>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-white">Update Sub Category Form</h5>
                                                ...
                                                <div class="border p-4 rounded">
                                                    ...
                                                    <form action="{{route('update-sub-category')}}" method="post">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="sub_category_name" value="{{ $subCategory->sub_category_name }}" id="" placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="row">
