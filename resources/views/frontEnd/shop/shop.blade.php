...
{{--                                    <div class="single_product">--}}
{{--                                        <div class="product_thumb">--}}
{{--                                            <a class="primary_img" href="product-details.html"><img src="{{asset('frontEnd')}}/assets/img/product/product13.jpg" alt=""></a>--}}
                        ...
                        <div class="tab-pane list_view fade" id="list" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-5">
                                        <div class="product_thumb">
                                            ...
                                            <a class="secondary_img" href="product-details.html"><img src="{{asset('frontEnd')}}/assets/img/product/product19.jpg" alt=""></a>
                                            <div class="quick_button">
                                                <a href="#" data-toggle="modal" data-target="#modal_box"  data-original-title="quick view"> quick view</a>
                                            </div>
                                        </div>
                            ...
                            <div class="single_product product_list_item">
                                <div class="row">
                                    <div class="col-lg-4 col-md-5">
                                        <div class="product_thumb">
                                            <a class="primary_img" href="product-details.html"><img src="{{asset('frontEnd')}}/assets/img/product/product20.jpg" alt=""></a>
                                            <a class="secondary_img" href="product-details.html"><img src="{{asset('frontEnd')}}/assets/img/product/product2.jpg" alt=""></a>
                                            <div class="quick_button">
                                                <a href="#" data-toggle="modal" data-target="#modal_box"  data-original-title="quick view"> quick view</a>
                                            </div>
