                        ...
                        <form action="#">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-20">
                                    ...
                                    <input type="text" value="{{Session::get('customerName')}}">
                                </div>
                                <div class="col-12 mb-20">
                                    <label>Phone Number</label>
                                    <input type="text" value="{{Session::get('customerPhone')}}">
                                </div>

                                <div class="col-12 mb-20">
                                    <label>House address  <span>*</span></label>
                                    <input type="text" value="{{Session::get('customerAddress')}}">
                                </div>

                                <div class="col-12 mb-20">
                                    <label> Email Address <span>*</span></label>
                                    <input type="email" value="{{Session::get('customerEmail')}}">
...
{{--                                    </tr>--}}
                                    ...
                                    <tr>
                                        <th>Shipping</th>
                                        <td><strong>30.00 Tk</strong></td>
                                    </tr>
                                    <tr class="order_total">
                                        <th>Order Total</th>
                                        <td><strong>{{$cartSub+30}}.00 Tk</strong></td>
                                    </tr>
                                        @else
                                        <tr>
                                            <th>Shipping</th>
                                            <td><strong>00.00 Tk</strong></td>
                                        </tr>
                                        <tr class="order_total">
                                            <th>Order Total</th>
                                            <td><strong>00.00 Tk</strong></td>
                            ...
                            <div class="payment_method">
                                ...
                                <div class="panel-default">
                                    ...
                                    <label for="payment_defult" data-toggle="collapse" data-target="#collapsedefult" aria-controls="collapsedefult">PayPal <img src="{{asset('frontEnd')}}/assets/img/icon/papyel.html" alt=""></label>
                                ...
                                <div class="order_button">
                                    <button  type="#">Proceed to PayPal</button>
                                </div>
                            </div>
                        </form>
                    </div>
