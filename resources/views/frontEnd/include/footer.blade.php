                    ...
                    <div class="col-lg-4 col-md-6 col-sm-7">
                        <div class="widgets_container product_widget">
                            ...
                            <div class="simple_product">
                                ...
                                @foreach($footerPros as $footerPro)
                                <div class="simple_product_items">
                                    <div class="simple_product_thumb">
                                        <a href="#"><img src="{{asset($footerPro->image)}}" alt=""></a>
                                    </div>
                                    <div class="simple_product_content">
                                        <div class="tag_cate">
                                            <a href="#">{{$footerPro->category_name}},</a>
                                            <a href="#">{{$footerPro->sub_category_name}}</a>
                                        </div>
                                        <div class="product_name">
                                            <h3><a href="#">{{$footerPro->product_name}}</a></h3>
                                        </div>
                                        <div class="product_price">
                                            <span class="old_price">${{$footerPro->product_price}}.00</span>
                                            <span class="current_price">${{$footerPro->discount_price}}.00</span>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
{{--                                <div class="simple_product_items">--}}
{{--                                    <div class="simple_product_thumb">--}}
{{--                                        <a href="#"><img src="{{asset('frontEnd')}}/assets/img/s-product/product4.jpg" alt=""></a>--}}
{{--                                    </div>--}}
{{--                                    <div class="simple_product_content">--}}
{{--                                        <div class="tag_cate">--}}
{{--                                            <a href="#">Women</a>--}}
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright_area">
                            <p>&copy; 2022 <a href="index.html" class="text-uppercase">All in One</a>. Made with <i class="fa fa-heart"></i> by <a target="_blank" href="#">Asadur Rahman</a></p>
